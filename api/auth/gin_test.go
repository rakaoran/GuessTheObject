...
// 			signupFunc:   func(s1, s2 string) (string, error) { return "", auth.ErrUsernameAlreadyExists },
// 			body:         `{}`,
...
// 			signupFunc:   func(s1, s2 string) (string, error) { return "", auth.ErrInvalidUsernameFormat },
// 			body:         `{}`,
...
// 			signupFunc:   func(s1, s2 string) (string, error) { return "", auth.ErrWeakPassword },
// 			body:         `{}`,
// 			expectedCode: http.StatusBadRequest,
...
// 			loginFunc:    func(s1, s2 string) (string, error) { return "", auth.ErrUsernameNotFound },
// 			body:         `{}`,
...
// 			loginFunc:    func(s1, s2 string) (string, error) { return "", auth.ErrIncorrectPassword },
// 			body:         `{}`,
// 			expectedCode: http.StatusUnauthorized,
// 			expectedBody: `{"error": "invalid-credentials"}`,
// 			cookieIssued: false,
...
// 	authService.verifyTokenFunc = func(s string) (string, error) { return "", auth.ErrInvalidToken }
// 	req = httptest.NewRequest(http.MethodGet, "/play", nil)
// 	req.AddCookie(&http.Cookie{Name: "token", Value: "oussama"})
